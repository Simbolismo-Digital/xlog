defmodule XlogWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {XlogWeb.Layouts, :root}
  ...
  # scope "/api", XlogWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:xlog, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: XlogWeb.Telemetry
